						...
						<div class="lh_dc">
							<div class="row">
								<div class="col-md-6 col-sm-6 col-xs 6">
									<p>
										TỔNG CÔNG TY DU LỊCH SÀI GÒN - TNHH MỘT THÀNH VIÊN<br>
										Address: 23 Lê Lợi, Quận 1, Hồ Chí Minh<br>
										Phone: (84.8) 3829 2291 - 3822 5874<br>
										Fax: 3822 5887<br>
										Email: saigontourist@sgtourist.com.vn<br>
										Website: http://saigon-tourist.com
									</p>
								</div>
								<div class="col-md-6 col-sm-6 col-xs 6">
									<img src="images/bd.png" alt="" width="100%">
								</div>
							</div>
						</div><!-- ./tintuc -->
						<div class="lienhe">
