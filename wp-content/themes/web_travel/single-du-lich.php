...
<body>
				...
				<div class="col-md-9 col-sm-9 col-xs-8 ">
					<<div class="sanpham">
						...
						<div id="carousel-id" class="carousel slide" data-ride="carousel">
							<?php 
							    $id=$post->ID;
								$img1=do_shortcode('[types field="hinh-1" id="$id" output="raw"]'); 
								$img2=do_shortcode('[types field="hinh-2" id="$id" output="raw"]'); 
								$img3=do_shortcode('[types field="hinh-3" id="$id" output="raw"]'); 
    ...
    background-size: contain;"></li>
								<li data-target="#carousel-id" data-slide-to="1" class="img" style="background:url(<?php echo $img2 ?>); margin-left: 120px;
    background-size: contain;"></li>
								<li data-target="#carousel-id" data-slide-to="2" class="img " style="background:url(<?php echo $img3 ?>); margin-left: 240px;
    background-size: contain;"></li>
							</ol>
